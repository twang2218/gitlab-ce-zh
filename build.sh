...
generate() {
    ...
    generate_tag_dockerfile     8.15.2-ce.0     v8.15.2     v8.15.2-zh      > 8.15/Dockerfile
    generate_branch_dockerfile  8.15.2-ce.0     v8.15.2     8-15-stable-zh  > testing/Dockerfile

    generate_docker_compose_yml 8.15.2 > docker-compose.yml
